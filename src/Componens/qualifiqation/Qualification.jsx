...
const Qualification = () => {
    ...
    return (
        <section className="qualiciqation section">
            ...
            <div className="qualification__container container">
                <div className="qualification__tabs">
                    ...
                    <div className={toggleState === 2 ? "qualification__button qualification__active button--flex" :
                     ...
                     onClick={() => toggleTab(2)}
                    >
                        <i className="uil uil-graduation-cap qualification__icon"></i>Experiencce
                    </div>
                </div>
                ...
                <div className="qualification__sections">
                    ...
                    <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">SMK 1 Bangkinang</span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <span className="qualification__rounder"></span>
                                <spam className="qualification__line"></spam>
                            </div>

                            <div>
                                <h3 className="qualification__title">Art Directior</h3>
                                <span className="qualification__subtitle">STMIK AMIK RIAU</span>
                                <div className="qualification__calender">
                    ...
                    <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualifiqation__title">Web Designer</h3>
                                <span className="qualifiqation__subtitle">SMK 1 Bangkinang</span>
                                <div className="qualifiqation__calender">
                                    <i className="uil uil-calender-alt"></i> 2021 - Present
                                </div>
                            </div>

                            <div>
                                <span className="qualifiqation__rounder"></span>
                                <span className="qualifiqation__line"></span>
                            </div>
                        </div>
